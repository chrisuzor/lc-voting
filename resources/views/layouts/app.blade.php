...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        <header class="flex items-center justify-between px-8 py-4">
            <a href="#"><img src="{{asset('img/logo.png')}}" alt="logo"></a>
                <div class="flex items-center">
                    ...
                    @endif
                    <a href="#">
                        <img src="https://www.gravatar.com/avatar/0000000000000000000000000000?d=mp"
        ...
        <main class="container mx-auto max-w-custom flex">
            <div class="w-70 mr-5">
                Idea form goes here. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur doloribus eligendi quos tempora veniam! Dolorem doloribus magni maxime veniam voluptates! Ab alias asperiores corporis culpa deleniti dolore hic illo iste labore nemo officiis porro quis, tempora tempore temporibus tenetur veniam.
            </div>
            <div class="w-175">
